---
title: The programming language for scalable development
template: splash
hero:
  image:
    alt: Icon
    file: ../../../public/icon.svg
  tagline: Pen is the parallel, concurrent, and functional programming language for scalable software development, focused on software maintainability and portability.
  actions:
    - text: Get started
      ...
      variant: primary
    - text: GitHub
      link: https://github.com/pen-lang/pen
      icon: github
      variant: secondary
---
