...
This page describes syntax of Pen. You can compose programs building up those language constructs. See also [Types](/references/language/types/) about syntax for specific data types.

## Module

Modules are sets of type and function definitions. Syntactically, a module consists of [statements](#statements). See [Modules](/references/language/modules/) about how modules themselves interact with each other.
...
See [Modules](/references/language/modules/) for more details.
...
See [Records](/references/language/types/#records) for more details.
...
[error-type]: /references/language/built-ins/#error
