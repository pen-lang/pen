...
It is an error. You can create error values by calling [the `error` built-in function](/references/language/built-ins/#error). See also [Error handling](/references/language/syntax/#error-handling).
