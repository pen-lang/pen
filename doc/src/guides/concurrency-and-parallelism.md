...
The `go` expression returns a function of the type same as the given expression (a.k.a futuresor promises in other languages.) The function returns a resulting value of the function execution.
