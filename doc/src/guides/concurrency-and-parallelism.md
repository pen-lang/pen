...
Pen provides some built-in functions for concurrent and parallel programming. [Its `go` built-in function](/references/language/built-ins.html#go) runs a given function concurrently, and possibly in parallel.
