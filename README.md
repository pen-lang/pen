...
Pen is a **functional** programming language following [Go][go]'s philosophy but focused on **application programming**. It aims for further simplicity, testability, and portability to empower team (v. individual) and/or long-term (v. short-term) productivity.
