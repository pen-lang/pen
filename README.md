...
Pen is a **functional** programming language following [Go][go]'s philosophy but focused on **application programming**. It aims for further simplicity, testability, and portability to empower long-term and/or team productivity.
