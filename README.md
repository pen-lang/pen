...
The reason we do not adopt any formal and statically provable effect system is to keep the language and its type system simple and easy to learn for the purpose of improving developer productivity and software development scalability; we want to make Pen accessible and easy to learn for both newbie and expert programmers.
