...
Pen is a statically typed functional programming language for scalable development. It's designed to make large-scale development efficient focusing on software **maintainability** and **portability**.
