...
fn move_expression(
    ...
    match expression {
        ...
        Expression::Case(case) => todo!(),
        Expression::CloneVariables(clone) => todo!(),
        Expression::ComparisonOperation(operation) => todo!(),
        Expression::DropVariables(drop) => todo!(),
        Expression::If(if_) => todo!(),
        Expression::Let(let_) => todo!(),
        Expression::LetRecursive(_) => todo!(),
        Expression::None => variables.clone(),
        Expression::Number(_) => variables.clone(),
        Expression::Record(record) => todo!(),
