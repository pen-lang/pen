use super::{
    ...
    record_field::RecordField, try_operation::TryOperation, type_information::TypeInformation,
    variable::Variable, variant::Variant, RecordUpdate, StringConcatenation, Synchronize,
};
...
impl From<TypeInformation> for Expression {
    fn from(information: TypeInformation) -> Self {
