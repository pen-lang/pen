use super::{
    function_definition::FunctionDefinition, type_definition::TypeDefinition, Declaration,
    ForeignDeclaration, TypeAlias,
};
...
impl Module {
    ...
    pub fn function_declarations(&self) -> &[Declaration] {
