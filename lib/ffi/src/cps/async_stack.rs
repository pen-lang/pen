...
#[repr(C)]
#[derive(Debug)]
pub struct AsyncStack<'a, S> {
    stack: Stack,
    context: Option<*mut Context<'a>>,
...
unsafe impl<'a, S: Send> Send for AsyncStack<'a, S> {}

impl<'a, S> Deref for AsyncStack<'a, S> {
    type Target = Stack;
...
impl<'a, S> DerefMut for AsyncStack<'a, S> {
